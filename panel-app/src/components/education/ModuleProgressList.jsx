      ...
      {modules.map((m) => {
        ...
        return (
          <button
            ...
            className="flex w-full items-center gap-3 rounded-xl border border-ink-100 bg-white p-3.5 text-left transition-colors hover:border-lavanda-200"
          >
            <span
              className={`flex h-6 w-6 shrink-0 items-center justify-center rounded-full border-2 transition-colors ${
                done ? 'border-lavanda-600 bg-lavanda-600 text-white' : 'border-ink-200 text-transparent'
              }`}
            >
