...
import { Settings, LogOut, ChevronDown, ChevronUp, Check, CreditCard, Bell, BellOff, BellRing } from 'lucide-react'
    ...
    <>
      ...
      <div className="p-2">
        ...
        <button
          ...
          disabled={signingOut}
          className="flex w-full items-center gap-2 rounded-lg px-2 py-2 text-sm text-brand-700 hover:bg-tint-red disabled:opacity-50"
        >
          <LogOut size={16} />
      ...
      <div className="relative" ref={ref}>
        ...
        >
          ...
          <div className="min-w-0 flex-1 leading-tight">
            ...
            <p className="truncate text-xs text-white/50">{ROLE_LABELS[role]}</p>
          </div>
          {open ? (
